...
export class CategoriesController {
  ...
  @ApiOperation({ summary: 'Obtener los datos de una Categoría en base a su ID' })
  ...
  @ApiOperation({ summary: 'Actualizar los datos de una Categoría en base a su ID' })
  @ApiParam({ name: 'id', description: 'ID de categoría' })
  @ApiResponse({ status: 200, description: 'Categoría actualizada' })
  @ApiResponse({ status: 404, description: 'Categoría no actualizada porque no existe' })
  @Patch(':id')
  ...
  @ApiResponse({ status: 404, description: 'Categoría no eliminada porque no existe' })
  @Delete(':id')
  @HttpCode(204)
  async remove(
    @Param('id') id: number,
  ...
  @ApiOperation({ summary: 'Obtener las Películas de una Categoría en base a su ID' })
  @ApiParam({ name: 'id', description: 'ID de categoría' })
  @ApiResponse({ status: 200, description: 'Listado de Películas asociadas al ID de Categoría' })
  @ApiResponse({ status: 404, description: 'Categoría no encontrada' })
  @Get(':id/movies')
